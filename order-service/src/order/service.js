...
class OrderService {
    ...
    async addOrderItems(restaurant_id, order_number, order_items) {
    ...
    async getAllOrdersByCustomer(id) {
        return orderRepository.getAllOrdersByCustomer(id);
    }

    async getAllOrdersByRestaurant(id) {
        return orderRepository.getAllOrdersByRestaurant(id);
    }
